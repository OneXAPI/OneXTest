...
static void TC_UpbitSpot(testDataType& td, uint64_t& pass, uint64_t& fail, bool& result){
    ...
    EXECUTE_UNITTEST(TC_UpbitSpot_subscribeTicker_5)
    ...
    EXECUTE_UNITTEST(TC_UpbitSpot_subscribeOrderbook_5)
...
static void TC_BinanceSpot(testDataType& td, uint64_t& pass, uint64_t& fail, bool& result){
    ...
    EXECUTE_UNITTEST(TC_BinanceSpot_fetchBalance_3)
    EXECUTE_UNITTEST(TC_BinanceSpot_fetchBalance_4)
    ...
    EXECUTE_UNITTEST(TC_BinanceSpot_fetchTradingFee_1)          //// 문제있음!!!!!!
    ...
    EXECUTE_UNITTEST(TC_BinanceSpot_fetchTicker_3)
    EXECUTE_UNITTEST(TC_BinanceSpot_fetchTicker_4)
    EXECUTE_UNITTEST(TC_BinanceSpot_fetchOrderbook_1)
    EXECUTE_UNITTEST(TC_BinanceSpot_fetchOrderbook_2)
    EXECUTE_UNITTEST(TC_BinanceSpot_fetchOrderbook_3)
    EXECUTE_UNITTEST(TC_BinanceSpot_fetchOrderbook_4)
    ...
    EXECUTE_UNITTEST(TC_BinanceSpot_subscribeTicker_5)
    EXECUTE_UNITTEST(TC_BinanceSpot_subscribeTicker_6)
    EXECUTE_UNITTEST(TC_BinanceSpot_subscribeTicker_7)
    EXECUTE_UNITTEST(TC_BinanceSpot_subscribeTicker_8)
    EXECUTE_UNITTEST(TC_BinanceSpot_subscribeTicker_9)
    ...
    EXECUTE_UNITTEST(TC_BinanceSpot_unsubscribeTicker_6)
    EXECUTE_UNITTEST(TC_BinanceSpot_unsubscribeTicker_7)
    EXECUTE_UNITTEST(TC_BinanceSpot_unsubscribeTicker_8)
    EXECUTE_UNITTEST(TC_BinanceSpot_unsubscribeTicker_9)
    ...
    EXECUTE_UNITTEST(TC_BinanceSpot_subscribeOrderbook_5)
    EXECUTE_UNITTEST(TC_BinanceSpot_subscribeOrderbook_6)
    EXECUTE_UNITTEST(TC_BinanceSpot_subscribeOrderbook_7)
    EXECUTE_UNITTEST(TC_BinanceSpot_subscribeOrderbook_8)
    EXECUTE_UNITTEST(TC_BinanceSpot_subscribeOrderbook_9)
    ...
    EXECUTE_UNITTEST(TC_BinanceSpot_unsubscribeOrderbook_6)
    EXECUTE_UNITTEST(TC_BinanceSpot_unsubscribeOrderbook_7)
    EXECUTE_UNITTEST(TC_BinanceSpot_unsubscribeOrderbook_8)
    EXECUTE_UNITTEST(TC_BinanceSpot_unsubscribeOrderbook_9)
}
...
static void TC_BinanceFutures(testDataType& td, uint64_t& pass, uint64_t& fail, bool& result){
    ...
    EXECUTE_UNITTEST(TC_BinanceFutures_fetchTicker_4)
    EXECUTE_UNITTEST(TC_BinanceFutures_fetchOrderbook_1)
    EXECUTE_UNITTEST(TC_BinanceFutures_fetchOrderbook_2)
    EXECUTE_UNITTEST(TC_BinanceFutures_fetchOrderbook_3)
    EXECUTE_UNITTEST(TC_BinanceFutures_fetchOrderbook_4)
    ...
    EXECUTE_UNITTEST(TC_BinanceFutures_subscribeMarketInfo_1)
    EXECUTE_UNITTEST(TC_BinanceFutures_subscribeMarketInfo_2)
    EXECUTE_UNITTEST(TC_BinanceFutures_subscribeMarketInfo_3)
    EXECUTE_UNITTEST(TC_BinanceFutures_subscribeMarketInfo_4)
    EXECUTE_UNITTEST(TC_BinanceFutures_subscribeMarketInfo_5)
    ...
    EXECUTE_UNITTEST(TC_BinanceFutures_unsubscribeMarketInfo_4)
    EXECUTE_UNITTEST(TC_BinanceFutures_unsubscribeMarketInfo_5)
    ...
    EXECUTE_UNITTEST(TC_BinanceFutures_subscribeTicker_5)
    ...
    EXECUTE_UNITTEST(TC_BinanceFutures_subscribeOrderbook_5)

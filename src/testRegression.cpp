...
static void TC_BinanceFutures(testDataType& td, uint64_t& pass, uint64_t& fail, bool& result){
    ...
    // EXECUTE_UNITTEST(TC_BinanceFutures_fetchDepositHistory_1)
    // EXECUTE_UNITTEST(TC_BinanceFutures_fetchDepositHistory_2)
    // EXECUTE_UNITTEST(TC_BinanceFutures_fetchDepositAddress_1)
    // EXECUTE_UNITTEST(TC_BinanceFutures_fetchDepositAddress_2)
    // EXECUTE_UNITTEST(TC_BinanceFutures_isDepositCompleted_1)
    // EXECUTE_UNITTEST(TC_BinanceFutures_isDepositCompleted_2)
    // EXECUTE_UNITTEST(TC_BinanceFutures_isDepositCompleted_3)
